...
def query(jsonStr):
    ...
    dt2 = datetime.strptime(dt, '%Y-%m-%dT%H:%M:%S')
    timestamp = str(datetime.timestamp(dt2))
    ...
    else: cosPhiDaily = 'NULL'

    cosPhiWeekly = ""
    if ('cosPhiWeekly' in values and not str(values['cosPhiWeekly']).isspace()):
        cosPhiWeekly = values['cosPhiWeekly']
    else: cosPhiWeekly = 'NULL'

#    device_id = str(device_id)
#    device_id = uuid.UUIDLoaderUUID(device_id)
#    o = { f"uuid": f"{device_id}" }
...
#    c.execute(sql, val)
#    toexecute= ("INSERT INTO metric_data (device_id, OPERATING_HOURS,PH_CON_TOT,PH_GEN_TOT,QH_Q1_TOT,QH_Q2_TOT,QH_Q3_TOT,QH_Q4_TOT,REPAIR_HOURS,V_PP,THDV_PP,THDI,REPCONN_STEP01,REPCONN_STEP02,REPCONN_STEP03,REPCONN_STEP04,REPCONN_STEP05,REPCONN_STEP06,REPCONN_STEP07,REPCONN_STEP08,REPCONN_STEP09,REPCONN_STEP10,REPCONN_STEP11,REPCONN_STEP12,POWLOSS_STEP01,POWLOSS_STEP02,POWLOSS_STEP03,POWLOSS_STEP04,POWLOSS_STEP05,POWLOSS_STEP06,POWLOSS_STEP07,POWLOSS_STEP08,POWLOSS_STEP09,POWLOSS_STEP10,POWLOSS_STEP11,POWLOSS_STEP12,OP_COUNT_STEP1,OP_COUNT_STEP2,OP_COUNT_STEP3,OP_COUNT_STEP4,OP_COUNT_STEP5,OP_COUNT_STEP6,OP_COUNT_STEP7,OP_COUNT_STEP8,OP_COUNT_STEP9,OP_COUNT_STEP10,OP_COUNT_STEP11,OP_COUNT_STEP12, cosPhiDaily, cosPhiWeekly) VALUES  ("device_id", OPERATING_HOURS","PH_CON_TOT","PH_GEN_TOT","QH_Q1_TOT","QH_Q2_TOT","QH_Q3_TOT","QH_Q4_TOT","REPAIR_HOURS","V_PP","THDV_PP","THDI","REPCONN_STEP01","REPCONN_STEP02","REPCONN_STEP03","REPCONN_STEP04","REPCONN_STEP05","REPCONN_STEP06","REPCONN_STEP07","REPCONN_STEP08","REPCONN_STEP09","REPCONN_STEP10","REPCONN_STEP11","REPCONN_STEP12","POWLOSS_STEP01","POWLOSS_STEP02","POWLOSS_STEP03","POWLOSS_STEP04","POWLOSS_STEP05","POWLOSS_STEP06","POWLOSS_STEP07","POWLOSS_STEP08","POWLOSS_STEP09","POWLOSS_STEP10","POWLOSS_STEP11","POWLOSS_STEP12","OP_COUNT_STEP1","OP_COUNT_STEP2","OP_COUNT_STEP3","OP_COUNT_STEP4","OP_COUNT_STEP5","OP_COUNT_STEP6","OP_COUNT_STEP7","OP_COUNT_STEP8","OP_COUNT_STEP9","OP_COUNT_STEP10","OP_COUNT_STEP11","OP_COUNT_STEP12", "cosPhiDaily", "cosPhiWeekly")")
    toexecute= (f"INSERT INTO metric_data (time,device_id, OPERATING_HOURS,PH_CON_TOT,PH_GEN_TOT,QH_Q1_TOT,QH_Q2_TOT,QH_Q3_TOT,QH_Q4_TOT,REPAIR_HOURS,V_PP,THDV_PP,THDI,REPCONN_STEP01,REPCONN_STEP02,REPCONN_STEP03,REPCONN_STEP04,REPCONN_STEP05,REPCONN_STEP06,REPCONN_STEP07,REPCONN_STEP08,REPCONN_STEP09,REPCONN_STEP10,REPCONN_STEP11,REPCONN_STEP12,POWLOSS_STEP01,POWLOSS_STEP02,POWLOSS_STEP03,POWLOSS_STEP04,POWLOSS_STEP05,POWLOSS_STEP06,POWLOSS_STEP07,POWLOSS_STEP08,POWLOSS_STEP09,POWLOSS_STEP10,POWLOSS_STEP11,POWLOSS_STEP12,OP_COUNT_STEP1,OP_COUNT_STEP2,OP_COUNT_STEP3,OP_COUNT_STEP4,OP_COUNT_STEP5,OP_COUNT_STEP6,OP_COUNT_STEP7,OP_COUNT_STEP8,OP_COUNT_STEP9,OP_COUNT_STEP10,OP_COUNT_STEP11,OP_COUNT_STEP12, cosPhiDaily, cosPhiWeekly) VALUES ('{tm}','{device_id}',{OPERATING_HOURS},{PH_CON_TOT},{PH_GEN_TOT},{QH_Q1_TOT},{QH_Q2_TOT},{QH_Q3_TOT},{QH_Q4_TOT},{REPAIR_HOURS},{V_PP},{THDV_PP},{THDI},{REPCONN_STEP01},{REPCONN_STEP02},{REPCONN_STEP03},{REPCONN_STEP04},{REPCONN_STEP05},{REPCONN_STEP06},{REPCONN_STEP07},{REPCONN_STEP08},{REPCONN_STEP09},{REPCONN_STEP10},{REPCONN_STEP11},{REPCONN_STEP12},{POWLOSS_STEP01},{POWLOSS_STEP02},{POWLOSS_STEP03},{POWLOSS_STEP04},{POWLOSS_STEP05},{POWLOSS_STEP06},{POWLOSS_STEP07},{POWLOSS_STEP08},{POWLOSS_STEP09},{POWLOSS_STEP10},{POWLOSS_STEP11},{POWLOSS_STEP12},{OP_COUNT_STEP1},{OP_COUNT_STEP2},{OP_COUNT_STEP3},{OP_COUNT_STEP4},{OP_COUNT_STEP5},{OP_COUNT_STEP6},{OP_COUNT_STEP7},{OP_COUNT_STEP8},{OP_COUNT_STEP9},{OP_COUNT_STEP10},{OP_COUNT_STEP11},{OP_COUNT_STEP12},{ cosPhiDaily},{ cosPhiWeekly})")
#    return (sql, val);      ('{device_id}',{OPERATING_HOURS},{
    return toexecute
